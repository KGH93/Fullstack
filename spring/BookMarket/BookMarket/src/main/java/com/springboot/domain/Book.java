...
public class Book {
    ...
    private MultipartFile bookImage;  //도서이미지 업로드 위해 필드선언
...
//
//
//    public Book(String bookId, String name, BigDecimal unitPrice, String author, String description, String publisher, String category, long unitsInStock, String releaseDate, String condition) {
//        this.bookId = bookId;
//        this.name = name;
//        this.unitPrice = unitPrice;
//        this.author = author;
