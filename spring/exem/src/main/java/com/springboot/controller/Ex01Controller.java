...
//
//    @GetMapping("/ex01")
//    public String showedForm(Model model){
//        model.addAttribute("product", new Product());
//        return "view01";
//    }
//
//    @PostMapping("/ex01")
//    public String submitshow(@Valid @ModelAttribute Product product, BindingResult bindingResult){
//
...
//
//    @PostMapping("/exem03")
//    public String submit3(@Valid @ModelAttribute Member member, BindingResult bindingResult){
//
//        if(bindingResult.hasErrors())
//            return "viewPage04";
//
