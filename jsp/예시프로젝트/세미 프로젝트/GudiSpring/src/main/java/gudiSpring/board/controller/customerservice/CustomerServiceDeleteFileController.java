...
@WebServlet("/board/customerserviceboard/deleteFile")
public class CustomerServiceDeleteFileController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            String filePath = basePath + fileName; // fileName에 이미 board/가          
            ...
            if (file.exists() && file.isFile()) {
                if (file.delete()) {
                 ...
                 // 성공적으로 삭제된 경우, 수정 페이지로 리다이렉션
                    res.sendRedirect(req.getContextPath() + "/board/customerserviceboard/edit?contentNo=" + contentNo);
                } else {
