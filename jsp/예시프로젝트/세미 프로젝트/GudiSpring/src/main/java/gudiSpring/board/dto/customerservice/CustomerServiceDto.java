package gudiSpring.board.dto.customerservice;
...
public class CustomerServiceDto {
	   ...
	   private int contentNo;               // 게시글 번호
		...
		public CustomerServiceDto(int contentNo, String contentSubject, String contentText, List<String> contentFiles,
		...
		public CustomerServiceDto(int contentNo, String contentSubject, String contentText, int contentBoardInfoNo,
