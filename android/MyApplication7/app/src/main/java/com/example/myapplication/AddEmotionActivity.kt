...
import com.example.myapplication.databinding.ActivityAddEmotionBinding

import java.text.SimpleDateFormat
import java.util.*
// AddEmotionActivity 사용자가 자신의 감정과 관련된 내용을 입력 및 젖ㅇ
class AddEmotionActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //감정 선택 : 미리 정의된 감정 중 하나 선택 할 수 있는 dropdown (Spinner)
        ...
        binding.btnSave.setOnClickListener {
            ...
            if (content.isNotBlank()) {
                ...
                viewModel.addEmotion(emotion) //객체를 EmotionViewModel 에 추가
                finish()
            }
        }
    }
